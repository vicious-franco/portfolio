...
const NavBar = () => {
  ...
  return (
    <motion.nav
      ...
      } px-10 md:px-15 border-b-1 border-[#02a94c]/60 bg-transparent rounded-b-xl left-0 top-0  backdrop-blur-md py-3 shadow-md shadow-[#484468b0] shadow-md/40 w-full text-white z-10`}
    >
