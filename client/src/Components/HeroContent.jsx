    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          ...
          <h1 className="welcome-text text-[13px] px-5 py-2 sm:py-0.5">
        ...
        >
          <div className="text-2xl leading-8 w-full text-wrap inline-block overflow-hidden text-start  items-center">
            ...
            <motion.span
              ...
              className="mx-4 text-transparent text-nowrap  bg-clip-text bg-gradient-to-r from-[#02a94c] to-cyan-600"
            >
            ...
            <span className="flex text-gray-300/95 gap-2 text-3xl sm:text-5xl text-nowrap">
              ...
              <Typewriter
                options={{
                  ...
                  loop: true,
                  wrapperClassName:
                    "text-transparent inline-block bg-clip-text bg-gradient-to-r from-[#02a94c] to-cyan-600",
        ...
        <div>
          ...
          <span
            ...
            className="lg:hidden inline-block text-[#02a94c] cursor-pointer hover:text-[#4bd3a8f0]"
          >
        ...
        <motion.a
          ...
          className="py-2 border-[#02a94c] border text-[#02a94c] hover:bg-[#02a94c] font-semibold text-center hover:-translate-1.5 hover:scale-105 transition-color duration-300 hover:text-white cursor-pointer rounded-lg max-w-[200px]"
        >
          Say Hello!
        </motion.a>
      </div>
            ...
            {socialIcons.map(({ icon: Icon, color, link }, index) => {
              return (
                <a
                  ...
                  className="hover:text-[#02a94c] duration-400 hover:text-2xl text-xl cursor-pointer"
                  key={index + 1}
                >
                  <Icon />
                </a>
