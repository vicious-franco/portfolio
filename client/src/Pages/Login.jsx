      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <form className=" p-8 inline-block rounded-lg border border-[#02a94c]/30 bg-green-500/2  w-[90%] sm:w-[30em] ">
          <div className="text-center">
            <h1 className="font-bold uppercase text-4xl mb-5 bg-gradient-to-b from-white/10 to-green-500 text-transparent bg-clip-text">
              Login
            </h1>
          </div>
          <div className="flex flex-col gap-4 mb-3">
            ...
            <button
              type="submit"
              className="capitalise bg-gradient-to-b from-0 to-green-500/40 border border-green-800 capitalize rounded-full outline-none py-2 my-4"
            >
              sign in
            </button>
